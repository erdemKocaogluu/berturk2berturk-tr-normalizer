...
def write_results_md(scores, datasets, examples, summary, gold, out):
    L = ["# Training Report — BERTurk2BERTurk Turkish Normalizer\n"]
...
<title>Training Dashboard — BERTurk2BERTurk Turkish Normalizer</title>
...
<header><h1>Training Dashboard — BERTurk2BERTurk Turkish Normalizer</h1>
...
const info=D.summary||{}, hp=info.hyperparameters||{};
...
def main():
    ...
    ap.add_argument("--model_dir", default=os.path.join(ROOT, "models/berturk2berturk-tr-normalizer"))
